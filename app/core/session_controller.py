...
class SessionController(QObject):
    ...
    def __init__(
        ...
        super().__init__()
        self.dataset_manager: Any = dataset_manager
        self.label_manager: Any = label_manager
        self.model_manager: Any = model_manager
        self.color_manager: Any = color_manager
        self.state: Any = session_state

    # --- Save labels ---
    def save(self, path: Optional[str] = None, fmt: Optional[str] = None) -> None:
    ...
    # --- Load labels ---
    def load_labels(self, path: str, fmt: str) -> None:
    ...
    def open_dataset(self, folder: str) -> None:
    ...
    def edit_class(self, class_id: int, new_class_name: str, color: Any) -> None:
    ...
    # --- Label management ---
    def add_label(
        self, file: str, class_name: int, label_type: str, coords: List[Any]
    ) -> None:
    ...
    def remove_label(self, file: str, label_id: int) -> None:
